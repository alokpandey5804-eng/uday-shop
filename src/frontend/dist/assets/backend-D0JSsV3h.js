...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, m as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, o as lookupResultToBuffer, p as RequestStatusResponseStatus, U as UnknownError, q as RequestStatusDoneNoReplyErrorCode, t as RejectError, v as CertifiedRejectErrorCode, w as UNREACHABLE_ERROR, I as InputError, x as InvalidReadStateRequestErrorCode, y as ReadRequestType, z as Principal, A as IDL, B as MissingCanisterIdErrorCode, H as HttpAgent, D as encode, Q as QueryResponseStatus, F as UncertifiedRejectErrorCode, G as isV3ResponseBody, J as isV2ResponseBody, K as UncertifiedRejectUpdateErrorCode, N as UnexpectedErrorCode, O as decode, S as Subscribable, V as pendingThenable, W as resolveEnabled, s as shallowEqualObjects, X as resolveStaleTime, k as noop, Y as environmentManager, Z as isValidTimeout, _ as timeUntilStale, $ as timeoutManager, a0 as focusManager, a1 as fetchState, a2 as replaceData, n as notifyManager, r as reactExports, l as shouldThrowError, g as useQueryClient, a3 as useInternetIdentity, a4 as createActorWithConfig, a5 as Record, a6 as Variant, a7 as Vec, a8 as Service, a9 as Func, aa as Opt, ab as Text, ac as Nat, ad as Float64, ae as Null, af as Int, ag as Bool } from "./index-kKW6gZ0D.js";
...
const Category = Record({ "id": Text, "name": Text });
Service({
  "addProduct": Func(
    [
      Text,
  ...
  "deleteProduct": Func([Text, Nat], [Bool], []),
  "editProduct": Func(
    [
      Text,
      Nat,
  ...
  "getOrdersByPhone": Func([Text], [Vec(Order)], ["query"]),
  "getProduct": Func([Nat], [Opt(Product)], ["query"]),
  "listCategories": Func([], [Vec(Category)], ["query"]),
  "listOrders": Func([Text], [Vec(Order)], []),
  "listProducts": Func(
    [Opt(Text), Opt(Float64), Opt(Float64)],
    [Vec(Product)],
    ["query"]
  ),
  "updateOrderStatus": Func([Text, Nat, Text], [Bool], []),
  "verifyAdmin": Func([Text], [Bool], ["query"])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const OrderItemInput2 = IDL2.Record({
    "productId": IDL2.Nat,
    "quantity": IDL2.Nat
  });
  ...
  const Order2 = IDL2.Record({
    ...
    "deliveryPincode": IDL2.Text,
    "createdAt": Timestamp2,
    "deliveryCity": IDL2.Text,
  ...
  const Category2 = IDL2.Record({ "id": IDL2.Text, "name": IDL2.Text });
  return IDL2.Service({
    ...
    "deleteProduct": IDL2.Func([IDL2.Text, IDL2.Nat], [IDL2.Bool], []),
    ...
    "getOrdersByPhone": IDL2.Func([IDL2.Text], [IDL2.Vec(Order2)], ["query"]),
    ...
    "listProducts": IDL2.Func(
      [IDL2.Opt(IDL2.Text), IDL2.Opt(IDL2.Float64), IDL2.Opt(IDL2.Float64)],
      [IDL2.Vec(Product2)],
      ["query"]
    ),
    ...
    "verifyAdmin": IDL2.Func([IDL2.Text], [IDL2.Bool], ["query"])
  });
};
...
class Backend {
  ...
  async addProduct(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  ...
  async createOrder(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    if (this.processError) {
      try {
  ...
  async editProduct(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
    if (this.processError) {
      try {
...
function from_candid_OrderStatus_n5(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n6(_uploadFile, _downloadFile, value);
}
function from_candid_Order_n3(_uploadFile, _downloadFile, value) {
